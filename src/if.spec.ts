...
describe('If Function and Conditional Logic', () => {
  it('should support basic if-then-else values', () => {
    const query = `
  ...
  describe('Complex Scenarios', () => {
    it('should support nested if expressions', () => {
      const query = `
        from object to object
        transform
    ...
    it('should work with arithmetic expressions in branches', () => {
      const query = `
        from object to object
        transform
